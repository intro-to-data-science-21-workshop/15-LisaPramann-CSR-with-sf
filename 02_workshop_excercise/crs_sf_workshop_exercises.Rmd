...
In the presentation we have shown how to use `sf` in combination with `ggplot` or the `sf` `sf_plot()` function to create simple maps. 
...
us_income <- left_join( 
  ...
  by = c("NAME" = "state"))
us_income_plot <- sf::plot_sf(us_income["median_income_15"], 
...
$~$
***
### Exercise (5) Public Policy implications 
