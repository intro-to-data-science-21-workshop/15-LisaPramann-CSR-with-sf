...
Refreshing you knowledge from your Geo-course in high school/undergrad studies...

.pull-left-small2[
<div align="center">
<br>
<img src="~/15-LisaPramann-CSR-with-sf/sf_presentation_files/figure-html/earth_measured.png" width=600>
</div>

---
#What are CRS?
##Coordinate Reference Systems (or Geographic Coordination Systems) 
...
- latitude (horizontal) 
- longitude (vertical)
- basis for planar coordinates and GIS (Geoinfomration Systems)
...
As you have seen the Ellipsoid cannot model the earth completely 

Therefore, different CRS exist:

- World Geodetic System (WGS84, EPSG:4326)
approx. the whole earth
standard model
