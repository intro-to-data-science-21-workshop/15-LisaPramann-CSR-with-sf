...
.pull-left-center[
<div align="center">
<img src="sf_presentation_files/figure-html/planar_corrdinates.jpg" width=300>
</div>
`Credit`[Sreedevi, 2021 ](https://www.analyticsvidhya.com/blog/2021/09/how-to-visualise-data-in-maps-using-geopandas/)
]

.pull-right-center[
<div align="center">
<br><br>
<img src="sf_presentation_files/figure-html/long_lat.jpg" width=300>
</div>
`Credit`[Mike Mitter, 2019](https://www.mikemitterer.at/2019/07/11/latitude-longitude-module-ist-auf-npmjs/
)
]
...
<b> Simple Features for R </b> 
<b> Simple features </b> refers to a formal standard (ISO 19125-1:2004) that describes how objects in the real world (such as a building or a tree) can be represented in computers, with emphasis on the spatial geometry of these objects.
