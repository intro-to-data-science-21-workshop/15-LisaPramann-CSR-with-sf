...
proj_vector = st_set_crs(new_vector, "EPSG:2163") # set CRS
```
```{r, include=FALSE}
...
ggsave("../thisplot.jpg", width = 6, height = 4)


ggplot() +
geom_sf(data = proj_vector) + #For simple plots, you will only need geom_sf() 
coord_sf(crs = st_crs(2163)) #ensures that all layers use a common CRS (would not be needed in this case)
ggsave("../thisplot2.jpg", width = 6, height = 4)

```

.pull-left[
<div align="left">
<img src="~/thisplot.jpg" width=400>
</div>]

.pull-right[
<div align="center">
<br><br>
<img src="~/thisplot2.jpg" width=400>
</div>]
